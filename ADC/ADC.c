 ...
 * @return  none
 */
void ADC_Function_Init(void)    //开头调用，ADC初始化
{
    ADC_InitTypeDef  ADC_InitStructure = {0};
    GPIO_InitTypeDef GPIO_InitStructure = {0};

    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);     //选APB-GPIO
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_ADC1, ENABLE);      //选APB-ADC

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;                 //选PIN
    ...
    ADC_DMACmd(ADC1, ENABLE);                                 //HERE TOO
    ADC_Cmd(ADC1, ENABLE);
}
